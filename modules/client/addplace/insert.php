...
if ($uploadOk == 0) {
	...
	$q1 = $connection->prepare("INSERT INTO places(place_id, latitude, longitude, name, address, rate_max, rate, image, type, user_id, contact) VALUES (:place_id, :lat, :lng, :name, :address, :rate_max, :rate, :image, :type, :user_id, :contact)");
